...
if (agent == "android" || agent == "linux") {
            window.location.href = "http://www.qlsp.cc/sx.htm";//如果是安卓则跳转到这个网址,注意:如果不需要跳转,而是维持在原网页,则把该行代码删掉
        } else if (agent == "ios") {
            window.location.href = "http://www.qlsp.cc/sx.htm";//如果是IOS则跳转到这个网址,注意:如果不需要跳转,而是维持在原网页,则把该行代码删掉
        } else if (agent == "wp") {
            window.location.href = "http://www.qlsp.cc/sx.htm";//如果是wp则跳转到这个网址,注意:如果不需要跳转,而是维持在原网页,则把该行代码删掉
        } else if (agent == "pc") {
            window.location.href = "http://www.yq1.cc/sx.htm";//如果是PC则跳转到这个网址,注意:如果不需要跳转,而是维持在原网页,则把该行代码删掉
        } else {
            //其他
        }
